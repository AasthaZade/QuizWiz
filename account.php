...
if (@$_GET['q'] == 'quiz' && @$_GET['step'] == 2) {
    ...
    echo '<br /><button type="submit" class="btn btn-primary" style="border-radius:0%"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span>&nbsp;Submit</button>';

    if ($sn > 1) {
        // Display the "Previous" button to go back to the previous question
        echo '<a class="btn btn-primary" style="border-radius:0%" href="account.php?q=quiz&step=2&eid=' . $eid . '&n=' . ($sn - 1) . '&t=' . $total . '&qid=' . $qid . '">
                <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>&nbsp;Previous
              </a>';
    }

    if ($sn < $total) {
        // Display the "Next" button to go to the next question
        echo '<a class="btn btn-primary" style="border-radius:0%" href="account.php?q=quiz&step=2&eid=' . $eid . '&n=' . ($sn + 1) . '&t=' . $total . '&qid=' . $qid . '">
